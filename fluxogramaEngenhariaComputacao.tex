...
\begin{tikzpicture}
  ...
  \disciplina{eletronica}{3}{7} {\CircEletICod} {\CircEletISName} {\CircEletICred} {CircEletI} % Circuitos Eletrônics I
...
\setcounter{numEletivas}{3} % 3 eletivas de 4 créditos cada
