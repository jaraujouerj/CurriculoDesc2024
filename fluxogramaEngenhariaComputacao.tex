...
\begin{tikzpicture}
  ...
  %Disciplinas Desc
  \disciplina{desc}{1}{7} {\IntCompCod}	{\IntCompSName}{\IntCompCH}{\IntCompCred}{AlgComp} % Introdução à Eng. de Computação
  ...
  \disciplina{desc}{5}{1} {\ICCod}	{\ICSName}{\ICCH}{\ICCred}{IC} % Inteligência Computacional
  ...
  \disciplina{desc}{7}{7} {\TelepCod}	{\TelepSName}{\TelepCH}{\TelepCred}{Telep} % Teleprocessamento
