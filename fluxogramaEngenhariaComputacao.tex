...
\begin{tikzpicture}
  ...
  \disciplina{industrial}{7}{7}{\EmpreCod}{\EmpreSName}{\EmpreCH}{\EmpreCred}{Empre} % Empreendedorismo
  \disciplina{mecanica}{4}{5}{\FenTranCod}{\FenTranSName}{\FenTranCH}{\FenTranCred}{FenTran} % Fenômenos de Transporte
  ...
  \disciplina{mecanica}{4}{4}	{\ResMatCod}	{\ResMatSName}{\ResMatCH}{\ResMatCred}{ResMat} % Resistência dos Materiais
  \disciplina{industrial}{8}{7}	{\SegHigCod}	{\SegHigSName}{\SegHigCH}{\SegHigCred}{SegHig} % Engenharia do Trabalho
  ...
  \disciplina{desc}{4}{2} {\FundICompCod}	{\FundICompSName}{\FundICompCH}{\FundICompCred}{FundIComp} % Fundamentos de Computadores
  \disciplina{desc}{5}{2} {\FundCompCod}	{\FundCompSName}{\FundCompCH}{\FundCompCred}{FundComp} % Fundamentos de Computadores
  \disciplina{desc}{6}{2} {\ICCod}	{\ICSName}{\ICCH}{\ICCred}{IC} % Inteligência Computacional
  \disciplina{desc}{6}{4} {\ICIICod}	{\ICIISName}{\ICIICH}{\ICIICred}{ICII} % Inteligência Computacional
  ...
  \disciplina{desc}{8}{2} {\CompParalCod}	{\CompParalSName}{\CompParalCH}{\CompParalCred}{ProgPara} % Programação Paralela
  ...
  \disciplina{desc}{8}{6} {\SredesCod}	{\SredesSName}{\SredesCH}{\SredesCred}{SO} % Sistemas Operacionais
  ...
  \pre	[red]   {AlgComp}	{AnAlg}   {-1}{3}{-8}{4}{0}
  \pre	[blue]  {AlgComp}	{FundComp}{-2}{2}{-14}{2}{-1}
  \pre	[blue]	{CalcI}		{CalcNum}{1}{-2}{0}{-1}{0}
  \prereq				{CalcI}		{CalcII}
  \pre	[red]	{CalcI}	{ProbEst} {-2}{2}{-14}{2}{0}

  % Período 2
  \pre				{EstrInf}	{LabProgI}{1}{2}{8}{2}{0}
  \pre[teal] 		{EstrInf}	{LabProgII}{-3}{1}{-11}{2}{0}
  ...
  \pre				{MecTec}	{ResMat}{-2}{2}{-14}{2}{0}
  %\prereq			  {CalcIII}	{CalcIV}
  \pre [red]		{ProbEst}	{ProcImag}  {-1}{1}{-13}{3}{-1}
 ...
 \pre [red]	  {FisIII}	{MatEle}  {3}{-4}{0}{-1}{0}
  ...
  \pre			    {ModMat}	{CEVI}    {-2}{4}{-8}{2}{-1}
  \pre[blue]	  {CEV}		  {CEVI}    {0}{-4}{0}{2}{0}
  \prereq	{FundIComp}{FundComp} 


  % % Período 5
  \pre[purple]	{FundComp}{ArqComp} {-3}{-4}{0}{-3}{2}
  \pre	  {CEV}		  {EletI}    {-1}{-5}{0}{0}{-4}
  \prereq				{FisEIII}		{FisEIV}

  % % Período 6
  \pre[red]  {AnAlg}		{Comp}{-2}{5}{-13}{2}{0}
