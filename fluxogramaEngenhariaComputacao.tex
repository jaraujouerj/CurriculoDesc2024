...
\newcommand{\disciplina}[7] {
  \addtocounter{cred}{#6}
  \def\horasdisc{\inteval{15 * #6}}%  Usando xfp (LaTeX moderno)
  \ifthenelse{\equal{#1}{extensao}}
    {} % Se for extensao, não faz nada com thoras
    {\addtocounter{thoras}{\horasdisc}} % Caso contrário, soma a carga horária
...
\begin{tikzpicture}
  ...
  \disciplina{eletrica}{5}{3} {\SinaisESistCod}{\SinaisESistSName}{\SinaisESistCred}{SinaisESist} % Modelos Matemáticos
  ...
  \disciplina{desc}{4}{3} {\ProcImagCod}	{\ProcImagSName}{\ProcImagCred}{ProcImag} % Processamento de Imagens
...
\immediate\write\exportfile{%
  \% ====================================^^J%
  \% ARQUIVO GERADO AUTOMATICAMENTE^^J%
  \% Valores calculados em fluxograma.tex^^J%
  \% ====================================^^J%
  \noexpand\setcounter{thoras}{\the\value{thoras}}^^J%
  \noexpand\setcounter{cred}{\the\value{cred}}^^J%
  \noexpand\setcounter{hextensao}{\the\value{hextensao}}%
}
