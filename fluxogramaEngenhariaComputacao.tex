...
\begin{tikzpicture}
  ...
  \disciplina{basico}{4}{3}{\CalcIVCod}	{\CalcIVSName}	{\CalcIVCH}{\CalcIVCred}	{CalcIII} % Cálculo IV
  ...
  \disciplina{eletronica}{4}{4} {\ModMatCod}	{\ModMatSName}{\ModMatCH}{\ModMatCred}{ModMat} % Modelos Matemáticos
  \disciplina{industrial}{6}{6} {\MetQuantCod}	{\MetQuantSName}{\MetQuantCH}{\MetQuantCred}{PO} % Métodos Quantitativos
  ...
  \disciplina{mecanica}{3}{1}	{\ResMatCod}	{\ResMatSName}{\ResMatCH}{\ResMatCred}{ResMat} % Resistência dos Materiais
  \disciplina{industrial}{8}{4}	{\SegHigCod}	{\SegHigSName}{\SegHigCH}{\SegHigCred}{SegHig} % Engenharia do Trabalho


  %Disciplinas Desc
  \disciplina{desc}{1}{2} {\IntCompCod}	{\IntCompSName}{\IntCompCH}{\IntCompCred}{AlgComp} % Introdução à Eng. de Computação
  \disciplina{desc}{1}{1} {\AlgCompCod}	{\AlgCompSName}{\AlgCompCH}{\AlgCompCred}{AlgComp} % Algoritmos Computacionais
  \disciplina{desc}{3}{2} {\AnAlgCod}	{\AnAlgSName}{\AnAlgCH}{\AnAlgCred}{AnAlg} % Análise de Algoritmos
  \disciplina{desc}{5}{1} {\GrafosCod}	{\GrafosSName}{\GrafosCH}{\GrafosCred}{AnAlg} % Teoria de Grafos e Aplicações
  \disciplina{desc}{6}{3} {\ArqCompCod}	{\ArqCompSName}{\ArqCompCH}{\ArqCompCred}{ArqComp} % Arquitetura de Computadores
  \disciplina{desc}{8}{3}{\ControlCod}	{\ControlSName}{\ControlCH}{\ControlCred}{Control} % Controle
  ...
  \disciplina{desc}{6}{4} {\ICIICod}	{\ICIISName}{\ICIICH}{\ICIICred}{IC} % Inteligência Computacional
