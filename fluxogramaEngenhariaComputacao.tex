...
%\disciplina{industrial}{7}{7}	{\SegHigCod}	{\SegHigSName}{\SegHigCH}{\SegHigCred}{SegHig} % Ergonomia e Segurança do Trabalho
  ...
  \disciplina{eletronica}{4}{4} {\FundICompCod}	{\FundICompSName}{\FundICompCH}{\FundICompCred}{FundIComp} % Técnicas Digitais
...
\begin{multicols}{4}
  ...
  \addtocounter{cred}{-9}
  (\the\value{cred} créditos em disciplinas obrigatórias e\\ 9 créditos em disciplinas eletivas restritas)
