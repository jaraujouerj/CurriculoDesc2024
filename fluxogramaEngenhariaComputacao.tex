...
\begin{tikzpicture}
  ...
  \disciplina{ambiental}{8}{6}	{\IntAmbCod}	{\IntAmbSName}{\IntAmbCH}{\IntAmbCred}{IntAmb} % Introdução à Engenharia Ambiental
  ...
  \disciplina{mecanica}{3}{2}	{\ResMatCod}	{\ResMatSName}{\ResMatCH}{\ResMatCred}{ResMat} % Resistência dos Materiais
