...
\begin{tikzpicture}
  ...
  \node [below  of=basico,node distance=5mm,fill=cmecanica, draw=black, label=right:Mecânica.] (mecan) {};
  \node [below  of=mecan,node distance=5mm,fill=cambiental, draw=black, label=right:Ambiental.] (ambient) {};
  \node [below  of=ambient,node distance=5mm,fill=cindustrial, draw=black, label=right:Industrial.] (indust) {};
  \node [below  of=indust,node distance=5mm,fill=celetrica, draw=black, label=right:Elétrica.] (eletri) {};
  \node [below  of=eletri,node distance=5mm,fill=celetronica, draw=black, label=right:Eletrônica.] (prof) {};
  \node [below of=prof,node distance=5mm,fill=cdesc, draw=black, label=right:Computacão.] (especifico){};
