...
\begin{tikzpicture}
  ...
  \disciplina{desc}{6}{1}	{\MineraDadosCod}	{\MineraDadosSName}{\MineraDadosCred}{MineraDados} % Mineração de Dados
  ...
  \pre	[red]   {AlgComp}	{AnAlg}     {-4}{4}{-9}{4}{0}
  \pre  [olive] {AlgLin}	{CalcNum}   {-4}{4}{0}{3}{0}
  \pre          {LogProg} {AnAlg}     {2}{3}{0}{-2}{0}
  \pre	[blue]	{CalcI}		{CalcNum}   {5}{4}{0}{-3}{0}
  \prereq				{CalcI}		{CalcII}
  \pre	[red]	  {CalcI}	  {ProbEst}   {2}{4}{14}{2}{0}
  \pre	[teal]	{CalcI}	  {FisII}     {-4}{2}{-10}{3}{-4}
  \pre	[blue]	{AlgLin}  {ProcIma}   {-2}{5}{-10}{3}{-4}
  ...
  \pre[teal]   	{LabProgI}  {ICII}        {-4}{2}{-15}{5}{-2}
  \pre[blue]    {LabProgII} {EngSistA} {3}{2}{-9}{3}{-2}
  \prereq				{FisIII}	  {FisIV}
  \prereq	      {TecDig}    {FundComp}
  \pre [teal] 	{FisIII}	  {CCC} {5}{4}{0}{-3}{0}
  \prereq[blue]	{CCC}		    {CCA}
  \coreq				{FisIII}	  {FisEIII}

  % Período 5
  \pre[purple]	{FundComp}{ArqComp} {-3}{3}{0}{0}{0}
  \prereq			{FisEIII}		{FisEIV}
  \coreq				{FisIV}	{FisEIV}
  \prereq [red]	  {FisIV}	{MatEle}
  \pre[teal]  {IC}		  {MineraDados} {5}{4}{0}{-3}{0}

  % Período 6
  \prereq		    {EngSistA}{EngSistB}
  \pre[blue]		{ArqComp}	{SO}        {-3}{3}{0}{0}{0}
  \pre				  {ArqComp}	{SistEmb}   {3}{3}{10}{4}{0}
  \pre[black]    {CCA}{Instala}       {3}{1}{10}{4}{0}

  % Período 7
  \prereq				{SO}		{ProgPara}
  \pre[blue]		{SO}		{Control}       {-3}{4}{0}{1}{0}
  \prereq[red]  {Telep} {Sredes}
  \pre          {EngSistB}{AnaProjSist} {3}{2}{0}{0}{0}
