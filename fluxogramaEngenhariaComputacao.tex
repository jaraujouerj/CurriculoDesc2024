...
\immediate\write\exportfile{%
  \unexpanded{\newcommand{\totalHorasCurso}{\the\value{thoras}}}^^J%
  \unexpanded{\newcommand{\totalCredCurso}{\the\value{cred}}}^^J%
  \unexpanded{\newcommand{\horasExtensao}{\the\value{hExtensao}}}^^J%
  \unexpanded{\newcommand{\totalHorasSemExtensao}{\the\value{horasSemExtensao}}}^^J%
  \unexpanded{\newcommand{\horasDiscExtensao}{\the\value{horasDiscExtensao}}}^^J%
  \unexpanded{\newcommand{\totalCredDiscExtensao}{\the\value{credExtensao}}}^^J%
  \unexpanded{\newcommand{\totalHorasACE}{\the\value{horasACE}}}^^J%
  \unexpanded{\newcommand{\totalDisciplinas}{\the\value{tdisciplinas}}}^^J%
}
