...
\begin{tikzpicture}
  ...
  \disciplina{desc}{5}{1} {\AnAlgCod}	{\AnAlgSName}{\AnAlgCH}{\AnAlgCred}{AnAlg} % Análise de Algoritmos
  \disciplina{desc}{6}{6} {\GrafosCod}	{\GrafosSName}{\GrafosCH}{\GrafosCred}{AnAlg} % Teoria de Grafos e Aplicações
