...
\immediate\write\exportfile{%
  ...
  \% ====================================^^J%
  \noexpand\newcommand{totalHorasCurso}{\the\value{thoras}}^^J%
  \noexpand\newcommand{totalCredCurso}{\the\value{cred}}^^J%
  \noexpand\newcommand{horasExtensao}{\the\value{hExtensao}}^^J%
  \noexpand\newcommand{totalHorasSemExtensao}{\the\value{horasSemExtensao}}^^J%
  \noexpand\newcommand{horasDiscExtensao}{\the\value{horasDiscExtensao}}^^J%
  \noexpand\newcommand{totalCredDiscExtensao}{\the\value{credExtensao}}^^J%
  \noexpand\newcommand{totalHorasACE}{\the\value{horasACE}}^^J%
}
