...
\newcommand{\disciplina}[8] {
  ...
  \ifthenelse{\equal{#1}{extensao}}
    {} % Se for extensao, não faz nada com thoras
    {\addtocounter{thoras}{#6}} % Caso contrário, soma a carga horária
...
\begin{tikzpicture}
  ...
  \disciplina{basico}{2}{3} {\CalcNumCod}    {\CalcNumSName}{\CalcNumCH}{\CalcNumCred}{CalcNum} % Cálculo Numérico
  ...
  \disciplina{eletrica}{5}{5}	{\CCCCod}	{\CCCSName}		{\CCCCH}	{\CCCCred}		{CCC} % Circuitos em corrente Conínua
  \disciplina{eletrica}{6}{5}{\CCACod}	{\CCASName}	{\CCACH}	{\CCACred}		{CCA} % Circuitos em Corrente Alternada
  ...
  \disciplina{industrial}{7}{6}{\MacroEcoCod}{\MacroEcoSName}{\MacroEcoCH}{\MacroEcoCred}{MacroEco} % Macro economia aplicada à Engenharia
  ...
  \disciplina{eletrica}{5}{3} {\SinaisESistCod}	{\SinaisESistSName}{\SinaisESistCH}{\SinaisESistCred}{SinaisESist} % Modelos Matemáticos
  \disciplina{eletrica}{4}{4} {\LogCircDigCod}	{\LogCircDigSName}{\LogCircDigCH}{\LogCircDigCred}{LogCircDig} % Lógica e Circuitos Digitais
  ...
  \disciplina{desc}{8}{2} {\AnaProjSistCod}	{\AnaProjSistSName}{\AnaProjSistCH}{\AnaProjSistCred}{AnaProjSist} % Sistemas de Informação
  \disciplina{desc}{7}{3} {\ProjBDCod}	{\ProjBDSName}{\ProjBDCH}{\ProjBDCred}{EngSistB} % Engenharia de Sistemas B
  \disciplina{extensao}{9}{3} {\EstSupCod}	{\EstSupSName}{\EstSupCH}{\EstSupCred}{EstSup} % Estágio Supervisionado
  ...
  \disciplina{desc}{4}{2} {\LabProgPOOCod}	{\LabProgPOOSName}{\LabProgPOOCH}{\LabProgPOOCred}{LabProgII} % Laboratório de Programação II
  ...
  \disciplina{extensao}{3}{2} {\ExtCod}	{\ExtSName}{\ExtCH}{\ExtCred}{Ext} % Projetos de Extensão
  ...
  \pre  [blue]   {CalcIII}	{SinaisESist}   {-1}{1}{-13}{3}{-1}
  ...
  \pre [red]		{SinaisESist}	{CCA}    {0}{-5}{0}{-4}{0}
...
% Ao final do arquivo, após todos os cálculos:
...
\begin{multicols}{4}
  ...
  (\the\value{cred} créditos em disciplinas obrigatórias\\ 13 créditos em disciplina de extensão e\\ 12 créditos em disciplinas eletivas restritas)
