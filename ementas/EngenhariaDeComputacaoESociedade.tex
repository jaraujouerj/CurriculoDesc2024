...
\ementa	{Bases histórica, teórica e conceitual da engenharia de computação. A engenharia e a metodologia científica. A ciência e a tecnologia e suas inter-relações com a engenharia. Impactos políticos, estratégicos e econômicos da tecnologia na indústria. Tecnologias industriais básicas e propriedade intelectual. Prospecção tecnológica, transferência de tecnologia e cerceamento tecnológico. Inovação e empreendedorismo na formação do engenheiro. Pesquisa e o desenvolvimento em engenharia. O projeto de engenharia. A função social do engenheiro. A ética em engenharia. O engenheiro de computação e sua inserção na indústria e na área de serviços.
}
