...
\ementa	{Bases histórica, teórica e conceitual da engenharia de computação. A engenharia e a metodologia científica. Impactos políticos, estratégicos, econômicos e ambientais da tecnologia na indústria. Sustentabilidade na engenharia de computação: desafios e soluções. Impactos ambientais do ciclo de vida de hardware/software. Computação verde: eficiência energética e a redução de emissões de carbono. Casos de inovação sustentável. Propriedade intelectual. Prospecção tecnológica, transferência de tecnologia e cerceamento tecnológico. Inovação e empreendedorismo na formação do engenheiro. Pesquisa e o desenvolvimento em engenharia.  A ética em engenharia. O engenheiro de computação e sua inserção na indústria e na área de serviços.
}
