...
\begin{table}[!ht]
    ...
    \begin{spreadtab}{{tabularx}{0.8\textwidth}{Xcc}}
        ...
        @ \Ext                  & \ExtCH          & \ExtCred              \\ % Laboratório de Programação A
        \hline
        @ \textbf{Total}        & sum(b2:b7)      & sum(c2:c7)            \\
        \hline
    \end{spreadtab}
...
\begin{table}[!ht]
    ...
    \label{tabeletivas}
    \begin{spreadtab}{{tabularx}{0.9\textwidth}{Xcc}}
        \hline
        @ {\textbf{Disciplina}} & @ {\textbf{CH}}  & @ {\textbf{Créditos}} \\
        \hline
...
% 		\CCC                  & \CCCCod         \\ % Circuitos em Corrente Contínua
...
\begin{table}[!ht]
    ...
    \resizebox{0.95\textwidth}{!}{%
        \begin{tabularx}{\textwidth}{|X||X|l|}
            ...
            \CalcNum                  & Cálculo Numérico IV                                       & IME04-04541                   \\
            ...
            \LabProgPOOSName          & Carac. das Linguagens de Prog. I                          & FEN06-03980                   \\
            ...
            \SinaisESist              & Modelos Mat. Aplicados a Eng. Elétrica III                & FEN05-04923                   \\
            \CCC                      & Circuitos Elétricos I                                     & FEN04-00944                   \\
            ...
            \CCA                      & Circuitos Elétricos IV                                    & FEN04-05222                   \\
            ...
            \AnaProjSist              & Engenharia de Sistemas C                                  & FEN06-04386                   \\
            ...
            \MacroEco                 & Introdução à Economia III                                 & FCE02-04657                   \\
...
No currículo do curso de Engenharia de Computação da UERJ, as atividades extensionistas totalizam \hExtensao horas, representando 10\% da carga horária total do curso, que é de \tHorasCurso horas, em conformidade com a determinação do CNE.
...
\begin{itquotation}
    Art.~\ordm{7} \S~\ordm{1}   As Instituições de Educação Superior deverão estabelecer a
...
Esta proposta está alinhada às recentes diretrizes nacionais de inserção da extensão na educação superior, encontrando respaldo em modelos já implementados com sucesso, como no Projeto Pedagógico do curso de Engenharia de Computação da Universidade Federal do Rio Grande do Norte (UFRN).\footnote{\url{https://encurtador.com.br/XHLYd}, consultado em 18/04/2025.} No referido curso, o Estágio Curricular Obrigatório, com carga horária de 160 horas, é integralmente contabilizado como atividade extensionista, justificando-se pelo atendimento aos princípios estabelecidos nos artigos \ordm{5} e \ordm{7}  da Resolução CNE/CES \ordm{n}  7/2018, que define as Diretrizes para a Extensão na Educação Superior Brasileira.
...
Na UERJ, a Deliberação CSEPE/UERJ \ordm{n} 04/2023, que regulamenta a inserção da extensão nos currículos de graduação, oferece respaldo adicional a esta proposta. O Art. \ordm{2} define a extensão universitária como um processo educativo, cultural e científico que articula ensino e pesquisa, promovendo a transformação social. O Art. \ordm{3} amplia o rol de atividades de extensão para incluir práticas com \textbf{protagonismo estudantil} e devidamente registradas institucionalmente.
