...
\begin{table}[h!]
    ...
    \begin{tabularx}{0.75\textwidth}{Xrrr}
        ...
        \hline
        \textbf{Total do curso}                & \tCredCurso               & \textbf{\tHorasCurso}       & \textbf{\hExtensao}   \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{small}
    \begin{longtable}{ >{\raggedright\arraybackslash\hspace{4pt}}p{11cm} c c }
        ...
        \hline
        \rowcolor{gray!20}\textbf{Total Geral}                                              & \hTotaisDisc   & \tCredCurso       \\
    \end{longtable}
\end{small}
...
Claro! Abaixo está uma sugestão de texto que você pode incluir no Projeto Pedagógico do Curso (PPC) de Engenharia de Computação, baseada no Art. 9º das Diretrizes Curriculares Nacionais (DCNs), com a carga horária mínima de 30 horas que você mencionou:

\section{Atividades Complementares}

As Atividades Complementares constituem um componente curricular obrigatório, conforme estabelecido pelo Artigo~\ordm{9} das Diretrizes Curriculares Nacionais para os cursos de graduação na área da Computação (Anexo~\ref{cne2016}). Seu propósito é ampliar e enriquecer a formação acadêmica dos estudantes, promovendo o desenvolvimento de habilidades, conhecimentos, competências e atitudes que vão além dos conteúdos abordados nas disciplinas regulares do curso.
...
As Atividades Complementares deverão ser devidamente documentadas e submetidas à apreciação da Coordenação do Curso, que será responsável pelo seu registro, avaliação e validação, conforme normas estabelecidas em regulamento próprio.
