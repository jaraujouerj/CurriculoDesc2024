...
\begin{table}[!ht]
    ...
    \begin{spreadtab}{{tabularx}{0.8\textwidth}{ Xcc }}
        ...
        \hline
        @ \rowcolor{gray!20}\textbf{Total} & sum(b2:b6)      & sum(c2:c6)            \\
        \hline
    \end{spreadtab}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{spreadtab}{{tabularx}{0.8\textwidth}{Xcc}}
        ...
        \hline
        @ \rowcolor{gray!20}\textbf{Total} & sum(b2:b7)      & sum(c2:c7)            \\
        \hline
    \end{spreadtab}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{spreadtab}{{tabularx}{0.8\textwidth}{Xcc}}
        ...
        \hline
        @ \rowcolor{gray!20}\textbf{Total} & sum(b2:b8)      & sum(c2:c8)            \\
        \hline
    \end{spreadtab}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{spreadtab}{{tabularx}{0.8\textwidth}{Xcc}}
        ...
        \hline
        @ \rowcolor{gray!20}\textbf{Total} & sum(b2:b4)      & sum(c2:c4)            \\
        \hline
    \end{spreadtab}
\end{table}
