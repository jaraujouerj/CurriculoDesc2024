...
\usepackage{pdflscape}   % para fazer páginas em paisagem
...
\usepackage{fmtcount} % para números por extenso
...
\defbibheading{bibintoc}[Referências]{%
	\chapter*{#1}
	\addcontentsline{toc}{chapter}{#1}}

\cleardoublepage  % Quebra de página para nova seção
\thispagestyle{plain}
