...
\begin{table}[!ht]
    ...
    \begin{tabularx}{0.5\textwidth}{Xr}
        \toprule
        \textbf{Componentes Curriculares}    & \textbf{Carga Horária}       \\
        \hline
        Disciplinas obrigatórias             & \hObrigatorias               \\
        Disciplinas eletivas                 & \hEletivas                   \\
        Disciplinas obrigatórias de extensão & \horasDiscExtensao           \\
        Atividades de extensão               & \totalHorasACE               \\
        \midrule
        Total                                & \textbf{\totalHorasCurso   } \\
        \toprule
    \end{tabularx}
\end{table}
